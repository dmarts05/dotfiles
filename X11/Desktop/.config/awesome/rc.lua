...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup{
        ...
        { -- Right widgets
            ...
            mytextclock,
            wibox.layout.margin(s.mylayoutbox, 8, 8, 8, 8)
        }
    }
end)
-- }}}
...
-- {{{ Key bindings
globalkeys = gears.table.join( -- Master and column manipulation
...
awful.key({}, "XF86MonBrightnessUp", function()
    ...
    os.execute("playerctl play-pause media")
end, {
...
clientkeys = gears.table.join( -- Resize windows (arrow keys)
